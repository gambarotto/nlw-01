...
import { View, TouchableOpacity, Image, Text, SafeAreaView, ActivityIndicator, Linking, StyleSheet } from 'react-native';
...
const Detail: React.FC = () => {
  ...
  function handleComposeEmail(){
    MailComposer.composeAsync({
      subject:'Interesser na coleta de resíduo',
      recipients: [data.point.email],
    });
  };

  if(!data.point){
    return <ActivityIndicator color='#34cb79' />
  }
